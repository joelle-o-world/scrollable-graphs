...
export const SignalGraph = ({ data, interval, color = '#000', scale = y => y, renderStyle = 'line', reductionRenderStyle = renderStyle, }) => {
    ...
    if (renderStyle == 'line') {
        ...
        return React.createElement("path", { d: pathString, stroke: color, fill: "none" });
    }
        ...
        return React.createElement("path", { d: pathString, stroke: "none", fill: color });
    }
    else
        return null;
};
